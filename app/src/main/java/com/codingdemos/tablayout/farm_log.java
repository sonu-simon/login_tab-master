...
public class farm_log extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_farm_log);
...
//        }
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(farm_log.this,registerScreen.class));
            }
        ...
        firebaseAuth.signInWithEmailAndPassword(userName,userPass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete( Task<AuthResult> task) {
                ...
                if(task.isSuccessful()){
                    Toast.makeText(farm_log.this,"Login succesfull",Toast.LENGTH_SHORT).show();

                    startActivity(new Intent(farm_log.this,farm_main.class));
                }
                else{
                    Toast.makeText(farm_log.this,"Login Failed",Toast.LENGTH_SHORT).show();
                    counter--;
